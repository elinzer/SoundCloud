                ...
                <div className='comment-section'>
                    ...
                    <ul className='comment-list'>
                        ...
                        {let createdDate = new Date(comment.createdAt); return (<li className='single-comment' key={comment.id}>{comment.body}
                            <li className='time-stamp'>Posted: {createdDate.toString()}</li>
                        </li>)})}
                    </ul>
                </div>
            </div>
        ...
        <div className='song-page-container'>
            ...
            <div>
                <div className='comment-section'>
                    ...
                    <ul className='comment-list'>
                        {commentsArr.map(comment =>
                            (<li className='single-comment' key={comment.id}>{comment.body} {comment.userId === sessionUser.id ? (<button className='delete-comment' onClick={(e) => sendDelete(e, comment.id)}><i className="fa-regular fa-trash-can" /></button>) : null}
                            <li className='time-stamp'>Posted: {comment.createdAt}</li>
                            </li>))}
                    </ul>
                </div>
            </div>
